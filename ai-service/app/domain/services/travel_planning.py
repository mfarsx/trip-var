...
class TravelPlanningService:
    ...
    @staticmethod
    async def create_plan(request: TravelPlanningRequest, user: User) -> TravelPlanningResponse:
        ...
        plan_db = TravelPlanInDB(
            ...
            status="draft",
            metadata={
                "budget_level": request.preferences.budget.value if request.preferences.budget else None,
