...
from app.models.text import TextGenerationRequest, TextGenerationResponse, GenerationHistory
from app.models.user import User
from app.core.config import settings
from app.repositories.text_generation import TextGenerationRepository
