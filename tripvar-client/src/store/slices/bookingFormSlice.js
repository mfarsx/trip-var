...
export const selectIsCheckingAvailability = (state) =>
  state.bookingForm.isCheckingAvailability;
export const selectAvailabilityChecked = (state) =>
  state.bookingForm.availabilityChecked;
